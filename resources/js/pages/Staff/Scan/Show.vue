...
<template>
    <Head :title="t('staff.scan.show.title', { name: wallet.first_name })" />

    <StaffLayout :title="t('staff.scan.show.title', { name: wallet.first_name })">
        <div class="space-y-6">
            <section
                v-if="!isActive"
            ...
            >
                <div class="flex items-start gap-2">
                    ...
                    <p>{{ t('staff.scan.show.disabled_notice') }}</p>
                </div>
            </section>
            ...
            <section>
                <h2 class="mb-3 text-sm font-semibold uppercase tracking-wider text-charcoal-500">
                    {{ t('staff.scan.show.actions_heading') }}
                </h2>
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                    ...
                    >
                        <ShoppingBag :size="18" />
                        {{ t('staff.scan.show.log_purchase') }}
                    </button>
                    <button
                        type="button"
                        :disabled="!isActive"
                    ...
                    >
                        <Sliders :size="18" />
                        {{ t('staff.scan.show.manual_adjust') }}
                    </button>
                </div>
            </section>
