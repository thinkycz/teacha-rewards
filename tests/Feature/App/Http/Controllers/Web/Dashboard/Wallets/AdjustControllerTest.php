...
\test('POST /dashboard/wallets/{wallet}/adjust type=add credits the wallet and records a note', function (): void {
    ...
    $response = $this->actingAs($staff)->post(
        "/dashboard/wallets/{$wallet->getKey()}/adjust",
        [
...
\test('POST /dashboard/wallets/{wallet}/adjust type=subtract debits the wallet', function (): void {
    $staff = User::factory()->staff()->create();
    $wallet = RewardWallet::factory()->create([
...
\test('POST /dashboard/wallets/{wallet}/adjust type=set overwrites the balance', function (): void {
    $staff = User::factory()->staff()->create();
    $wallet = RewardWallet::factory()->create([
...
\test('POST /dashboard/wallets/{wallet}/adjust rejects a note that is too short', function (): void {
    $staff = User::factory()->staff()->create();
    $wallet = RewardWallet::factory()->create();
...
\test('POST /dashboard/wallets/{wallet}/adjust rejects an unknown type', function (): void {
    $staff = User::factory()->staff()->create();
    $wallet = RewardWallet::factory()->create();
...
\test('POST /dashboard/wallets/{wallet}/adjust rejects a subtract larger than the balance', function (): void {
    $staff = User::factory()->staff()->create();
    $wallet = RewardWallet::factory()->create([
