...
\test('GET /staff returns 200 for a staff user', function (): void {
...
\test('GET /staff returns 200 for an admin user', function (): void {
...
\test('GET /staff redirects guests to login', function (): void {
